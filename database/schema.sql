...
(1,'Kashmiri Mongra Saffron','kashmiri-mongra-saffron',
 ...
 'The finest grade of Kashmiri saffron, known for its deep crimson colour, rich aroma, and exceptional flavour. Hand-picked from the picturesque saffron fields of Pampore, Kashmir. Each strand is carefully selected to ensure the highest quality. Rich in crocin, safranal and picrocrocin.',
...
(1,'Saffron Infused Honey','saffron-infused-honey',
 ...
 'A luxurious blend of pure Kashmiri honey infused with premium saffron strands. Rich in antioxidants and natural goodness.',
...
(2,'Premium Kashmiri Almonds','premium-kashmiri-almonds',
 ...
 'Fresh Kashmiri Mamra almonds, known for their distinctively sweet taste and high oil content. Rich in protein, healthy fats, and vitamins.',
 1299.00,999.00,'DRY-ALM-500G',150,'500g','Kashmir','prod-almonds.svg',1,4.8,87,4),
...
(2,'Kesar Pista','kesar-pista',
 ...
 1599.00,1299.00,'DRY-PIS-250G',80,'250g','Kashmir/Afghanistan','prod-pista.svg',0,4.6,45,5),
...
(2,'Dried Apricots (Khumani)','dried-apricots',
 ...
 799.00,649.00,'DRY-APR-500G',120,'500g','Ladakh','prod-apricots.svg',0,4.5,38,6),

(3,'Wild Forest Honey','wild-forest-honey',
 'Raw unprocessed Himalayan wild forest honey',
 'Unprocessed raw honey collected from wild bee colonies in Himalayan forests. Dark amber colour with robust complex flavour. Naturally rich in enzymes, antioxidants and minerals.',
 799.00,649.00,'HON-WLD-500G',90,'500g','Himachal Pradesh','prod-forest-honey.svg',1,4.7,72,7),

(3,'Acacia Flower Honey','acacia-flower-honey',
 'Light and delicate honey from acacia blossoms',
 'Light, mild honey collected from acacia blossoms. Known for its delicate flavour and very slow crystallisation. Perfect for teas, desserts and everyday use.',
 599.00,499.00,'HON-ACA-500G',110,'500g','Jammu & Kashmir','prod-acacia-honey.svg',0,4.5,41,8),
...
(4,'Kashmiri Kawa Tea','kashmiri-kawa-tea',
 ...
 699.00,549.00,'HRB-KAW-100G',200,'100g','Kashmir Valley','prod-kawa.svg',1,4.9,156,9),

(4,'Himalayan Shilajit','himalayan-shilajit',
 'Pure Grade-A Himalayan Shilajit resin with fulvic acid',
 'Pure Grade A Shilajit resin sourced from high-altitude Himalayan rocks. A powerful adaptogen with fulvic acid and 85+ minerals. Traditionally used in Ayurveda for energy and vitality.',
 1999.00,1699.00,'HRB-SHI-20G',60,'20g','Himalayas','prod-shilajit.svg',1,4.8,93,10);
